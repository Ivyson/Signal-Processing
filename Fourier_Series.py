...
# Assuming period T (for example, T = 10)
T = 10  # Example period
forier = sp.fourier_series(equation, (t, 0, T))

# Truncate the Fourier series to 10 terms
truncated_series = forier.truncate(40)

# Print the LaTeX form of the truncated Fourier series
sp.pprint(truncated_series)

# Optional: Plot the Fourier series (commented out)
# sp.plot(truncated_series, (t, 0, T))
# Plot both the original function and the truncated Fourier series on the same plot
